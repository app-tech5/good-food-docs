window.GOOD_FOOD_DOWNLOAD_CONFIG = {
  ...
  qrLabel: "Scan to download the restaurant APK",
  tips: [
    "Allow installation from unknown sources if Android prompts you.",
    "Grant notification permissions when prompted — the restaurant app needs them for new orders.",
    "Demo login: demo@restaurant.com / password123 (when demo mode is enabled in your build)."
  ]
};
